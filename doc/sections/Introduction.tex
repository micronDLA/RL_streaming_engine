...
\begin{enumerate}
    \item A Reinforcement Learning methodology that is able to map the instructions for a given DFG to the processing elements in the SE and has the potential to be reused across computation graphs.
    \item An analysis of different factors that impacts the quality of mappings obtained.
\end{enumerate}

This work is motivated to provide an improved toolset that lowers SE usability barrier.
