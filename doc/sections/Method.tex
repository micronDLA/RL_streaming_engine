...
Having a higher number of transformer encoder layers improves the best reward obtained but it is achieved at a cost of more parameters, making training more expensive.
...
We see the addition of GGA module provides improved reward and sample efficiency for various SDF graphs and different device configurations as shown in Section \ref{sec:GGA_result}.
