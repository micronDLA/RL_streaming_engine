...
After placing all nodes in an episode, a different graph can be fed into the GNN to train the RL model on a collection of computation graphs. 
...
We see the addition of GGA module provides improves reward and sample efficiency for various computation graphs and different device configuration as shown in section \ref{sec:GGA_result}.
