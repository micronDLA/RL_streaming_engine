...
\begin{figure*}[tb]
  ...
  \caption{Actor and critic model architecture. GNN is used to process the SDF graph (static data). 
...
We see the addition of GGA module provides improves reward and sample efficiency for various SDF graphs and different device configuration as shown in Section \ref{sec:GGA_result}.
