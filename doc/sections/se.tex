...
\begin{figure} [h]
  ...
  \end{subfigure}
  \caption{
    Layout of the SE device is shown in \figurename~\ref{fig:sub-se}, while \figurename~\ref{fig:sub-tile} details an SE tile.
  }
...
E
ach are the width of the data path (512-bits), and the depth will be in the range of 512 to 1024 elements.
